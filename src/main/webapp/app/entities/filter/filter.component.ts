...
export class FilterComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.filterService
            ...
            .subscribe(
                (res: HttpResponse<IFilter[]>) => this.paginateFilters(res.body, res.headers),
    ...
    trackId(index: number, item: IFilter) {
        return item.id;
    }
    ...
    private paginateFilters(data: IFilter[], headers: HttpHeaders) {
