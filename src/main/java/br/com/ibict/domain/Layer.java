...
public class Layer implements Serializable {
    ...
    public Layer metaDados(Set<MetaDado> metaDados) {
        this.metaDados = metaDados;
        return this;
    }

    public Layer addMetaDado(MetaDado metaDado) {
        this.metaDados.add(metaDado);
        metaDado.setLayer(this);
        return this;
    }

    public Layer removeMetaDado(MetaDado metaDado) {
        this.metaDados.remove(metaDado);
        metaDado.setLayer(null);
        return this;
    }
