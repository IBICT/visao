...
public class TypePresentationResource {
    ...
    public TypePresentationResource(TypePresentationRepository typePresentationRepository) {
    ...
    public ResponseEntity<TypePresentation> createTypePresentation(@RequestBody TypePresentation typePresentation) throws URISyntaxException {
        ...
        TypePresentation result = typePresentationRepository.save(typePresentation);
    ...
    @Timed
    public List<TypePresentation> getAllTypePresentations() {
        log.debug("REST request to get all TypePresentations");
        return typePresentationRepository.findAll();
    }
    ...
    public ResponseEntity<TypePresentation> getTypePresentation(@PathVariable Long id) {
        ...
        Optional<TypePresentation> typePresentation = typePresentationRepository.findById(id);
