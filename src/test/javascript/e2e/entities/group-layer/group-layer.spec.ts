...
describe('GroupLayer e2e test', () => {
    ...
    it('should load GroupLayers', () => {
        ...
        expect(groupLayerComponentsPage.getTitle()).toMatch(/visaoApp.groupLayer.home.title/);
    });
    ...
    it('should load create GroupLayer page', () => {
        ...
        expect(groupLayerUpdatePage.getPageTitle()).toMatch(/visaoApp.groupLayer.home.createOrEditLabel/);
