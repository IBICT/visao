...
describe('TypePresentation e2e test', () => {
    ...
    it('should load TypePresentations', () => {
        ...
        expect(typePresentationComponentsPage.getTitle()).toMatch(/Type Presentations/);
    });
    ...
    it('should load create TypePresentation page', () => {
        ...
        expect(typePresentationUpdatePage.getPageTitle()).toMatch(/Create or edit a Type Presentation/);
