...
describe('Indicator e2e test', () => {
    ...
    it('should load Indicators', () => {
        ...
        expect(indicatorComponentsPage.getTitle()).toMatch(/visaoApp.indicator.home.title/);
    });
    ...
    it('should load create Indicator page', () => {
        ...
        expect(indicatorUpdatePage.getPageTitle()).toMatch(/visaoApp.indicator.home.createOrEditLabel/);
