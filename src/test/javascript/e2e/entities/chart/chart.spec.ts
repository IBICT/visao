...
describe('Chart e2e test', () => {
    ...
    it('should load Charts', () => {
        ...
        expect(chartComponentsPage.getTitle()).toMatch(/Charts/);
    });

    it('should load create Chart page', () => {
        chartComponentsPage.clickOnCreateButton();
        chartUpdatePage = new ChartUpdatePage();
        expect(chartUpdatePage.getPageTitle()).toMatch(/Create or edit a Chart/);
    ...
    it('should create and save Charts', () => {
        ...
        chartUpdatePage
            ...
            .then(selected => {
                if (selected) {
                    chartUpdatePage.getExternalInput().click();
                    expect(chartUpdatePage.getExternalInput().isSelected()).toBeFalsy();
                } else {
                    chartUpdatePage.getExternalInput().click();
                    expect(chartUpdatePage.getExternalInput().isSelected()).toBeTruthy();
                }
            });
