    ...
    describe('Filter Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Filter', () => {
                service.create(new Filter(null)).subscribe(received => {
            ...
            it('should update a Filter', () => {
                service.update(new Filter(123)).subscribe(received => {
            ...
            it('should return a list of Filter', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Filter(123)]);
            });
