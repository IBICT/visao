...
import { GroupCategoryComponent } from 'app/entities/group-category/group-category.component';
...
describe('Component Tests', () => {
    describe('GroupCategory Management Component', () => {
        let comp: GroupCategoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GroupCategoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.groupCategories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
