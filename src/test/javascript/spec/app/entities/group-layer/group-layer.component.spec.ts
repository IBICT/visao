...
import { GroupLayerComponent } from 'app/entities/group-layer/group-layer.component';
...
describe('Component Tests', () => {
    describe('GroupLayer Management Component', () => {
        let comp: GroupLayerComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GroupLayerComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.groupLayers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
