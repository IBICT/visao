    ...
    describe('Indicator Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/indicators';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Indicator', () => {
                service.create(new Indicator(null)).subscribe(received => {
            ...
            it('should update a Indicator', () => {
                service.update(new Indicator(123)).subscribe(received => {
