    ...
    describe('Layer Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/layers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Layer', () => {
                service.create(new Layer(null)).subscribe(received => {
            ...
            it('should update a Layer', () => {
                service.update(new Layer(123)).subscribe(received => {
