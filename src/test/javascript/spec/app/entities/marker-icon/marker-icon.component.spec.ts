...
import { MarkerIconComponent } from 'app/entities/marker-icon/marker-icon.component';
...
describe('Component Tests', () => {
    describe('MarkerIcon Management Component', () => {
        let comp: MarkerIconComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MarkerIconComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.markerIcons[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
