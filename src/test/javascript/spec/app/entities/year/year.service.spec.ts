    ...
    describe('Year Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/years';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Year', () => {
                service.create(new Year(null)).subscribe(received => {
            ...
            it('should update a Year', () => {
                service.update(new Year(123)).subscribe(received => {
